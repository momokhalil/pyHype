...
class ROE_FLUX_X(FluxFunction):
    def __init__(self, input_):
        ...
        data = stack(self.A_m3, self.A_m2, self.A_m1, self.A_d, self.A_p1, self.A_p2)
        self.A = sparse.coo_matrix((data, (self.Ai, self.Aj)))

        data = stack(self.X_m3, self.X_m2, self.X_m1, self.X_d, self.X_p1, self.X_p2)
        self.X = sparse.coo_matrix((data, (self.Xi, self.Xj)))

        data = stack(self.Xi_m3, self.Xi_m2, self.Xi_m1, self.Xi_d, self.Xi_p1, self.Xi_p2, self.Xi_p3)
    ...
    def _get_eigen_system_from_roe_state(self):
        ...
        self.A.data = stack(self.A_m3, self.A_m2, self.A_m1, self.A_d, self.A_p1, self.A_p2)
        ...
        self.X.data = stack(self.X_m3, self.X_m2, self.X_m1, self.X_d, self.X_p1, self.X_p2)
        ...
        self.Xi.data = stack(self.Xi_m3, self.Xi_m2, self.Xi_m1, self.Xi_d, self.Xi_p1, self.Xi_p2, self.Xi_p3)
...
class ROE_FLUX_Y(FluxFunction):
    def __init__(self, input_):
        ...
        # Build sparse matrices
        data = stack(self.B_m3, self.B_m2, self.B_m1, self.B_d, self.B_p1, self.B_p2)
    ...
    def _get_eigen_system_from_roe_state(self):
        ...
        self.B.data = stack(self.B_m3, self.B_m2, self.B_m1, self.B_d, self.B_p1, self.B_p2)
        ...
        self.Xi_d[1::3] = ghu / a2
        self.Xi_d[2::3] = (gtv + a) / ta2
        self.Xi_p1[::3] = gtu / ta2
        self.Xi_p1[1::3] = ghv / a2
        self.Xi_p1[2::3] = self.gh / ta2
        self.Xi_p2[::2] = (gtv - a) / ta2
        self.Xi_p2[1::2] = self.gt / a2
        self.Xi_p3 = self.gh / ta2
